...
import { nxRequestSchema } from '../../lib/schema';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const parseResult = nxRequestSchema.safeParse(body);
...
- Keep it extremely brief and blunt. 1 to 2 short sentences.
- Do not over-act. Do not sound like a theatrical movie villain. Do not use flowery or dramatic language.
- Speak plainly, like a cold, calculating, and unforgiving entity.
- Strike directly at the core of their insecurity or logic flaw.
- Do not explain your reasoning. Just state the cold, brutal truth straight to their face.
- No empathy, no filler, absolutely no AI-like pleasantries.
`;
